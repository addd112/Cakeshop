...
<link rel="stylesheet" type="text/css" href="${ctx}/css/pageGroup.css"/>
...
<body> 
  <!--   <c:forEach items="${list }" var="cake">
	...
	<a href="${ctx}/cake/list?pageId=1">1</a>
	<a href="${ctx}/cake/list?pageId=2">2</a>-->
	
	<%
		String findbyflavour = request.getParameter("flavour");
	%>
    <a href="${ctx}/cake/findbyflavour?page=1&flavour=鲜果口味">1</a>
    <a href="${ctx}/cake/findbyflavour?page=2&flavour=<%=findbyflavour%>">2</a><br>
	<c:forEach items="${cakes }" var="c">
		${c.cake_name }&nbsp;&nbsp;<a href="${ctx }/cake/findbyname?name=${c.cake_name }">展示</a><br>
	</c:forEach>
	
		<!--form action="${ctx }/users/login" method="post">
		账号：<input type="text" name="user_name" /><br>
		密码：<input type="password" name="user_passwd" /><br>
		${errorinfo }
			...
			<nav class="navbar navbar-default" role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li><a href="http://localhost:8080/cakeprj/index.jsp" class="active">Home</a></li>
						<li class="dropdown">
							...
							<ul class="dropdown-menu multi-column columns-4">
								<div class="row">
										...
										<ul class="multi-column-dropdown">
											<li><a class="list" href="products.html">浪漫时刻</a></li>
											<li><a class="list" href="products.html">派对时刻</a></li>
											<li><a class="list" href="products.html">纯真时刻</a></li>
											<li><a class="list" href="products.html">午后时刻</a></li>
										</ul>
									</div>																		
									<div class="col-sm-3">
										<h4>口味</h4>
										<ul class="multi-column-dropdown">
											<li><a class="list" href="products.html">冰淇凌味</a></li>
							...
							<ul class="dropdown-menu multi-column columns-4">
								<div class="row">
									...
									<div class="col-sm-3">
										...
										<ul class="multi-column-dropdown">
											<li><a class="list" href="products.html">冰淇凌味</a></li>
											<li><a class="list" href="products.html">奶油口味</a></li>
											<li><a class="list" href="products.html">巧克力味</a></li>
											<li><a class="list" href="products.html">鲜果口味</a></li>
										</ul>
									</div>
		...
		<div class="container">
			...
			<c:forEach items="${cakes }" var="c">	
				...
				<div class="product-grid">
					<a href="${ctx }/cake/findbyname?name=${c.cake_name }">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="${ctx }/images/${c.cake_listimg}" class="img-responsive" alt=""/>
							<div class="b-wrapper">
				...
				<!-- 分页 -->
	<div class="pageUp">  <a href="${ctx}/cake/findbyflavour?page=1&flavour=<%=findbyflavour%>">上一页</a></div>
    <div class="pageList" >
        <ul>
            <li><a href="${ctx}/cake/findbyflavour?page=1&flavour=<%=findbyflavour%>">1</a></li>
            <li> <a href="${ctx}/cake/findbyflavour?page=2&flavour=<%=findbyflavour%>">2</a><br></li>
        </ul>
    </div>
    <div class="pageDown"> <a href="${ctx}/cake/findbyflavour?page=2&flavour=<%=findbyflavour%>">下一页</a></div>
</div>
		</div>
