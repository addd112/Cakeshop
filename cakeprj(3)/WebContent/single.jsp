			...
			<div class="single-grids">				
				<div class="col-md-4 single-grid">		
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="${ctx }/images/${c.cake_listimg}">
								<div class="thumb-image"> <img src="${ctx}/images/${c.cake_listimg}" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="${ctx }/images/${c.cake_img1}">
								 <div class="thumb-image"> <img src="${ctx}/images/${c.cake_img1}" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="${ctx }/images/${c.cake_img2}">
							   <div class="thumb-image"> <img src="${ctx}/images/${c.cake_img2}" data-imagezoom="true" class="img-responsive"> </div>
							</li> 
						</ul>
					</div>
				</div>	
